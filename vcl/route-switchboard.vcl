sub recv_route_switchboard {
  ...
  if ( req.url.path ~ "^/movies"
    ...
    || (req.url.path ~ "^/theweekly" || req.url.path ~ "^/the-weekly" || req.url.path ~ "^/weekly" || req.url.path ~ "^/column/the-weekly" || req.url.path ~ "^/column/theweekly" || req.url.path ~ "^/section/the-weekly")
