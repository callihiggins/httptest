  ...
  var scenarios = [
    {
      ...
      'responseHeaderPattern': {
        'set-cookie': /\bvistory=[az][012][0-9];/,
      },
    ...
    },
    {
      ...
      'requestScheme': 'https://',
      'requestUri': '/2017/01/05/business/nadav-test-123.html?abra=WP_ProjectVi_Story=st',
      'responseHeaderPattern': {
        'set-cookie': /\bvistory=[az][012][0-9];/,
      },
      'responseHeaderContains': {
    ...
    },
    {
      ...
      'requestScheme': 'https://',
      'requestUri': '/2017/01/05/business/nadav-test-123.html?abra=WP_ProjectVi_Story=horse',
      'responseHeaderPattern': {
        'set-cookie': /\bvistory=[az][012][0-9];/,
      },
      'responseHeaderContains': {
    ...
    },
    {
      ...
      'requestScheme': 'https://',
      'requestUri': '/2017/09/26/sports/nfl-trump.html?abra=WP_ProjectVi_Story=st',
      'responseHeaderPattern': {
        'set-cookie': /\bvistory=[az][012][0-9];/,
      },
      'responseHeaderContains': {
    ...
    },
    {
      ...
      'requestScheme': 'https://',
      'requestUri': '/2017/09/26/sports/nfl-trump.html?abra=WP_ProjectVi_Story=horse',
      'responseHeaderPattern': {
        'set-cookie': /\bvistory=[az][012][0-9];/,
      },
      'responseHeaderContains': {
