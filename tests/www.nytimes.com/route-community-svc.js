  ...
  var scenarios = [
    {
      ...
      'scenarioDescription': 'route-community-svc: test GetBasicInfo',
      'testId': 1,
    },
    {
      'isDeployedInEnv': {
      ...
      'responseStatusCode': 200,
      'scenarioDescription': 'route-community-svc: GetCommentSummary is cacheable if user not logged in',
      'testId': 2,
    },
    {
      'isDeployedInEnv': {
      ...
      'responseStatusCode': 200,
      'scenarioDescription': 'route-community-svc: GetCommentSummary is not cacheable if user is logged in',
      'testId': 3,
    },
  ]
  return scenarios;
