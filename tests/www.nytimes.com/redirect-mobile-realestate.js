...
function getScenarioEvents() {
  const scenarios = [
    ...
    },
    {
      ...
      requestScheme: 'https://',
      requestUri:
        '/real-estate/homes-for-sale/?locations%5B%5D=upper-west-side-new-york-ny-usa&locations%5B%5D=lower-east-side-new-york-ny-usa&redirect=find-a-home',
      responseHeaderMatches: {
        location:
          ' https://m.realestatelistings.nytimes.com/search?channel=sales&location=upper-west-side-(72nd-96th-street)-new-york-ny-usa&search=See+Available+Homes&redirect=find-a-home',
      },
      responseStatusCode: 302,
      scenarioDescription:
        'Test mobile realestate saved listings redirect; realestate; mobile; cookie "nyt-mobile=1"; does redirect',
    ...
    },
    {
      ...
      requestScheme: 'https://',
      requestUri:
        '/real-estate/homes-for-rent/?locations%5B%5D=upper-west-side-new-york-ny-usa&locations%5B%5D=lower-east-side-new-york-ny-usa&redirect=find-a-home',
      responseHeaderMatches: {
        location:
          ' https://m.realestatelistings.nytimes.com/search?channel=rentals&location=upper-west-side-(72nd-96th-street)-new-york-ny-usa&search=See+Available+Homes&redirect=find-a-home',
      },
      responseStatusCode: 302,
      scenarioDescription:
        'Test mobile realestate saved listings redirect; realestate; mobile; cookie "nyt-mobile=1"; does redirect',
