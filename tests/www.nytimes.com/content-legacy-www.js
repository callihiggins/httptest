...
function getScenarioEvents()
{
  var scenarios = [
    ...
    },
    {
      ...
      'requestScheme': 'https://',
      'requestUri': '/pages/opinion/index.html',
      'responseHeaderMatches': {
        'x-api-version': 'F-4',
        'x-cache': 'MISS',
        'x-frame-options': 'DENY',
      ...
      'responseStatusCode': [200, 404],
      'scenarioDescription': 'Test legacy; www cluster; section front',
      'testId': 34,
    },
    {
      'id': 'FunctionalTestScenarioDefinitionForHtmlPage',
    ...
    },
    {
      ...
      'requestScheme': 'http://',
      'requestUri': '/slideshow/2013/09/17/fashion/17trimmings.html',
      'responseHeaderMatches': {
        'x-api-version': 'F-5-4',
        'x-cache': 'MISS',
        'x-frame-options': 'DENY',
      ...
      'responseStatusCode': [200, 404],
      'scenarioDescription': 'Test legacy; www cluster; slideshow',
      'testId': 40,
    },
    {
      'id': 'FunctionalTestScenarioDefinitionForHtmlPage',
    ...
    },
    {
      ...
      'responseStatusCode': [200, 404],
      'scenarioDescription': 'Test legacy; www cluster; timespace',
      'testId': 43,
    },
    {
      'id': 'FunctionalTestScenarioDefinitionForHtmlPage',
